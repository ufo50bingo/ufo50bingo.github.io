export const SPICY = [
  [
    ...
    {
      name: 'PARTY HOUSE: Have 8 trouble on screen at once without using any fetch or peek abilities',
    ...
    {
      name: 'VAINGER: Defeat 3 bosses with all obtained modules placed in BODY',
      types: ['vainger', 'easy'],
    },
    ...
    { name: 'CAMPANELLA 2: Collect 4 max HP upgrades in a run', types: ['campanella2', 'easy'] },
    { name: 'CAMPANELLA 2: Collect 4 max HP upgrades in a run', types: ['campanella2', 'easy'] },
  ],
  [
    {
    ...
    {
      name: 'RAKSHASA: Clear Stage 2 defeating enemies ONLY with the spread weapon during the run',
      types: ['rakshasa', 'easy'],
    },
    {
      name: 'RAKSHASA: Clear Stage 2 defeating enemies ONLY with the purple homing weapon during the run',
      types: ['rakshasa', 'easy'],
    },
    ...
    { name: 'DIVERS: Kill a piranha', types: ['divers', 'easy'] },
  ...
  [
    {
      name: 'LORDS OF DISKONIA: Win a Quick Battle on Commander difficulty',
    ...
    {
      name: 'HOT FOOT: Reach round 4; in each round, the teammate that gets the first point must throw all bags for the rest of that round',
      types: ['hotfoot', 'easy'],
    },
    {
      name: 'RAIL HEIST: GOOD-SPUR allowed; Devil Star on levels 1-4, and beat Fowl Business while killing every chicken & lawman',
  ...
  [
    {
      name: 'BARBUTA: Obtain the blood sword, die an additional four times in that room (5 deaths total), then gold disk',
      types: ['barbuta', 'easy'],
    },
    { name: 'BARBUTA: Open 8 different chests', types: ['barbuta', 'easy'] },
    {
      name: 'OVERBOLD: Gold Disk & Purchase 3 price hiked items in one run',
      types: ['overbold', 'easy'],
    },
    { name: 'OVERBOLD: Gold Disk without purchasing any SALE items', types: ['overbold', 'easy'] },
    {
      name: 'MORTOL II: Defeat all three minibosses damaging them only as scout and engineer',
      types: ['mortolii', 'easy'],
    },
    ...
    {
      name: 'AVIANOS: Win a custom Fledgling game; Must spend all possible resources every turn (change castles/flags to 6/0)',
      types: ['avianos', 'easy'],
    },
    {
    ...
    {
      name: 'ONION DELIVERY: Complete 2 days in a run with 8+ onions and at least 25 seconds left on the timer both days',
  ...
  [
    ...
    {
      name: 'PILOT QUEST: Return the science gear to the crash site',
    ...
    { name: 'NINPEK: Have 8 extra lives at once', types: ['ninpek', 'easy'] },
    {
      name: 'WARPTANK: Beat Sectors without retrying at checkpoints, and destroying all possible enemies & blocks: Piston, Bomb, Tower, Healing, Stare',
      types: ['warptank', 'easy'],
    },
    {
    ...
    { name: 'CYBER OWLS: Have 5 extra lives at once', types: ['cyberowls', 'easy'] },
  ...
  [
    ...
    {
      name: 'PORGY: Obtain an upgrade item from the Abyss (armor, radar, efficient fuel)',
      types: ['porgy', 'medium'],
    },
    {
    ...
    { name: 'THE BIG BELL RACE: Cherry disk', types: ['thebigbellrace', 'medium'] },
    ...
    {
      name: 'CYBER OWLS: Use GETM-EOUT; Complete the rescue mini-game four times in a row',
    ...
    { name: 'WARPTANK: Collect 8 coffees', types: ['warptank', 'medium'] },
  ],
  [
    {
    ...
    {
      name: 'MAGIC GARDEN: Cherry disk in under 6:00 in-game time',
    ...
    {
      name: 'ATTACTICS: Win 5 ranked battles in a row; max of 2 units per line across the center at once',
  ...
  [
    ...
    { name: 'PINGOLF: Score -2 or better on six holes', types: ['pingolf', 'medium'] },
    {
      name: 'LORDS OF DISKONIA: In a full war, hold 64+ gold at once at any point, and win the war',
      types: ['lordsofdiskonia', 'medium'],
    },
    { name: 'NIGHT MANOR: Cherry disk', types: ['nightmanor', 'medium'] },
    {
  ...
  [
    {
      name: 'HYPER CONTENDER: Win tournament mode with two different characters; no rematches allowed (Default ring settings)',
      types: ['hypercontender', 'medium'],
    },
    {
      name: 'STAR WASPIR: Clear waves 1, 2, and 3 without using options (GGG) and having reached at least a 30x multiplier during the run',
    ...
    {
      name: 'VELGRESS: Cherry disk with in-game time of 3:33 or less (no star blocks)',
  ...
  [
    ...
    { name: 'BARBUTA: Cherry disk', types: ['barbuta', 'medium'] },
    {
    ...
    { name: 'GOLFARIA: Rescue 3 NPCs and hit 2 Parbots', types: ['golfaria', 'medium'] },
    {
  ...
  [
    { name: 'PINGOLF: Cherry with a score of -9 or better', types: ['pingolf', 'hard'] },
    { name: 'PINGOLF: Cherry with 3+ hole-in-one in the run', types: ['pingolf', 'hard'] },
    { name: 'KICK CLUB: Have 7 extra lives at once', types: ['kickclub', 'hard'] },
    {
      name: 'KICK CLUB: Beat Track World; Must finish each level (except bosses) with 14+ seconds left on the timer',
      types: ['kickclub', 'hard'],
    },
    {
  ...
  [
    ...
    {
      name: 'CAMPANELLA 3: Clear all waves through Stage D Wave 4 without firing sideways, then defeat Eggsaber',
    ...
    {
      name: 'WARPTANK: SLIM-TANK allowed; clear Dyad, Shock, and Port Sectors (no checkpoints)',
      types: ['warptank', 'hard'],
    },
    {
      name: 'WARPTANK: SLIM-TANK allowed; clear Axon, Deep, and Sacrum Sectors (no checkpoints)',
      types: ['warptank', 'hard'],
    },
    {
    ...
    {
      name: 'SEASIDE DRIVE: Wiin all 3 bonus games in one run without shooting any blcoks',
      types: ['seasidedrive', 'hard'],
    },
    { name: 'DEVILITION: Use FULL-RAND; Beat 6 levels', types: ['devilition', 'hard'] },
  ],
  [
    { name: 'HYPER CONTENDER: Gold disk on Hard Difficulty', types: ['hypercontender', 'hard'] },
    {
      name: 'HYPER CONTENDER: Beat Draft Mode on Hard Difficulty with 2 different characters',
      types: ['hypercontender', 'hard'],
    },
    {
      name: 'VAINGER: Collect three modules, then defeat Y-Vainger (exploit not allowed)',
      types: ['vainger', 'hard'],
    },
    {
      name: 'VAINGER: Collect three modules, then defeat the keycode boss in Theta Sector',
      types: ['vainger', 'hard'],
    },
    ...
    {
      name: 'CAMPANELLA 2: Turn on the lights in Temple Grounds; picking up the free fuel at the end of caves is banned during the run',
  ...
  [
    ...
    {
      name: 'PORGY: Defeat a boss in the second depth level (Bakunawa or Neptune)',
      types: ['porgy', 'hard'],
    },
    ...
    {
      name: 'BARBUTA: Enter four unique doors (exits do not count as new doors)',
      types: ['barbuta', 'hard'],
    },
    {
    ...
    { name: 'RAKSHASA: Gold disk with the default weapon only', types: ['rakshasa', 'hard'] },
    { name: 'MAGIC GARDEN: Gold Disk with 9,900 points or less', types: ['magicgarden', 'hard'] },
    {
    ...
    { name: 'ATTACTICS: Reach Rank 100 in Ranked Mode', types: ['attactics', 'hard'] },
    { name: 'DIVERS: Collect an emblem', types: ['divers', 'hard'] },
    { name: 'CARAMEL CARAMEL: Score 100,000+ points', types: ['caramelcaramel', 'hard'] },
    { name: 'ONION DELIVERY: Gold Disk', types: ['oniondelivery', 'hard'] },
    { name: 'ONION DELIVERY: Gold Disk', types: ['oniondelivery', 'hard'] },
  ],
  [
    {
      name: 'VALBRACE: Use BUGG-BODY; Defeat the Phantom Knight without dying; Thrones, items (except keys), and spells not allowed during the run',
      types: ['valbrace', 'hard'],
    },
    {
    ...
    {
      name: 'CYBER OWLS: Beat Congo & Moscow without killing any non-boss enemies',
      types: ['cyberowls', 'hard'],
    },
    { name: 'CYBER OWLS: Gold Disk', types: ['cyberowls', 'hard'] },
    ...
    {
      name: 'MINI & MAX: Collect a shiny quest reward from 4 different NPCs',
      types: ['miniandmax', 'hard'],
    },
    { name: 'MINI & MAX: Have 333 shinies', types: ['miniandmax', 'hard'] },
    {
    ...
    {
      name: 'MORTOL: OPEN-TOMB Allowed: Clear any 3 levels in worlds 2, 3, or 4 ending with +12 lives or more in each',
      types: ['mortol', 'hard'],
    },
  ],
  [
    ...
    { name: 'BARBUTA: Explore 48 different rooms', types: ['barbuta', 'veryhard'] },
    ...
    { name: 'MAGIC GARDEN: Win with a score of 100,000+', types: ['magicgarden', 'veryhard'] },
    {
      name: 'MAGIC GARDEN: Cherry disk with a MAXIMUM SCORE of 21,000 points',
      types: ['magicgarden', 'veryhard'],
    },
    {
      name: 'VELGRESS: Cherry disk without Upgrades or Jump Pads & finish with at least 75 coins held',
      types: ['velgress', 'veryhard'],
    },
    { name: 'VELGRESS: Gold disk 3 runs in a row', types: ['velgress', 'veryhard'] },
    { name: 'KICK CLUB: Cherry disk', types: ['kickclub', 'veryhard'] },
    {
      name: 'KICK CLUB: Gold disk with at least 3 extra lives remaining',
      types: ['kickclub', 'veryhard'],
    },
    {
      name: 'BLOCK KOALA: WORM-1234 allowed; clear any 10 odd-numbered story levels (levels 1-10 excluded)',
      types: ['blockkoala', 'veryhard'],
    },
    {
      name: 'BLOCK KOALA: WORM-1234 allowed; clear any 10 even-numbered story levels (levels 1-10 excluded)',
      types: ['blockkoala', 'veryhard'],
    },
  ...
  [
    ...
    { name: 'RAIL HEIST: Collect 20 stars', types: ['railheist', 'veryhard'] },
    ...
    { name: 'CAMPANELLA: Cherry disk', types: ['campanella', 'veryhard'] },
    { name: 'WARPTANK: Enter the cafe with at least 9 coffees', types: ['warptank', 'veryhard'] },
    ...
    { name: 'CARAMEL CARAMEL: Cherry disk', types: ['caramelcaramel', 'veryhard'] },
    {
      name: 'VAINGER: Obtain both stabilizers and any two keycodes',
      types: ['vainger', 'veryhard'],
    },
    { name: 'VAINGER: Obtain and equip all four modules', types: ['vainger', 'veryhard'] },
    { name: 'PARTY HOUSE: Beat 3 random scenarios in a row', types: ['partyhouse', 'veryhard'] },
    { name: 'PARTY HOUSE: Gold disk', types: ['partyhouse', 'veryhard'] },
    {
    ...
    {
      name: 'STAR WASPIR: Cherry Disk with at least 400,000 points',
  ...
  [
    ...
    { name: 'MORTOL: Have 80 lives at the end of a level', types: ['mortol', 'veryhard'] },
    {
    ...
    {
      name: 'MOONCAT: Collect 2 of 3 eggs with 6 or fewer deaths (sum of best per successful run)',
      types: ['mooncat', 'veryhard'],
    },
    { name: 'MOONCAT: Cherry disk', types: ['mooncat', 'veryhard'] },
    {
      name: 'WALDORF’S JOURNEY: Cherry disk; No puffins collected & at least 5 weather vanes must be interacted with during the run',
    ...
    {
      name: 'LORDS OF DISKONIA: Win a Full War on Commander difficulty',
      types: ['lordsofdiskonia', 'veryhard'],
    },
    { name: 'HOT FOOT: Cherry disk without Edgar or July', types: ['hotfoot', 'veryhard'] },
  ...
  [
    { name: 'RAKSHASA: Cherry disk', types: ['rakshasa', 'veryhard'] },
    { name: 'RAKSHASA: Gold disk without upgrading the weapon', types: ['rakshasa', 'veryhard'] },
    {
      name: 'FIST HELL: Beat the fourth scare as Cat; Limit of 2 upgrade purchases',
      types: ['fisthell', 'veryhard'],
    },
    {
      name: 'FIST HELL: Beat the fourth scare as Amy; Limit of 2 upgrade purchases',
      types: ['fisthell', 'veryhard'],
    },
    {
    ...
    { name: 'AVIANOS: BLUE-BEAK allowed; Beat Trial 5', types: ['avianos', 'veryhard'] },
    { name: 'AVIANOS: BLUE-BEAK allowed; Beat Trial 4', types: ['avianos', 'veryhard'] },
    {
  ...
  [
    ...
    {
      name: 'Enter a number 1 top score on 2 arcade leaderboards; must gold disk the games to count',
      types: ['general', 'general'],
    },
    { name: 'Enter a top 2 score on 3 arcade leaderboards', types: ['general', 'general'] },
  ],
  [
  ...
  [
    ...
    {
      name: 'CAMPANELLA TRILOGY II: Cherry disk 2 of the 3 Campanella Trilogy games',
      types: ['general', 'general'],
    },
    {
      name: 'ALPHA TRILOGY II: Cherry Disk Velgress, Overbold, and Quibble Race as Alpha',
      types: ['general', 'general'],
    },
    {
